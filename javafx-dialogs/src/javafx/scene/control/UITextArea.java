...
import static javafx.scene.control.Control.USE_PREF_SIZE;
...
class UITextArea extends Label
{
    ...
    /**
     * Creates a new instance of UITextArea with specified preferred width. This is used
     * by the dialog UI template.
     */
